-- Seed script to push mock categories and products to MySQL database
USE ecommerce;

-- Clear previous test data cleanly if needed
...
-- Insert Products
INSERT INTO product (name, description, price, stock, image, status, category_id) VALUES
